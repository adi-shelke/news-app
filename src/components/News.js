...
export default class News extends Component {
  ...
  async componentDidMount(){
    let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=09d7a6962b2f486d99781b8d1263661c&page=${this.state.page}&pageSize=20`
    console.log(url)
  ...
  nextPage=async()=> {
    ...
    {
      let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=09d7a6962b2f486d99781b8d1263661c&page=${this.state.page+1}&pageSize=20`
      let data = await fetch(url)
      data = await data.json()
