    ...
    return (
      <>
        <div className="container my-3">
          ...
          <button disabled={this.state.page+1>Math.ceil(this.state.totalResults/this.props.pageSize)} className="btn btn-success mx-2"onClick={this.nextPage}>Next &rarr;</button>
          </div>
        </div>
      </>
    );
